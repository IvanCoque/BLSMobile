...
export const RegisterScreen = ({navigation} : Props) => {
    ...
    //USEFORM
    const {email, password, nombre, cedula, fecha_nacimiento, sexo, estado_civil, religion, ocupacion, lugar_nacimiento, residencia, domicilio, telefono, onChange} = useForm({
        email : '',
        password : '',
    })
