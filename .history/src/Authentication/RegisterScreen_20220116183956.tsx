...
export const RegisterScreen = ({navigation} : Props) => {
    ...
    const onRegister = async ({nombre, email, password, cedula,/*fecha Nacimiento , sexo */ estado_civil, religion, ocupacion, lugar_nacimiento, residencia, domicilio, telefono, estado, username } : RegisterData) =>  {
        /*
        try{
        ...
        */
       console.log(nombre, email, password, cedula,/*fecha Nacimiento , sexo */ estado_civil, religion, ocupacion, lugar_nacimiento, residencia, domicilio, telefono, estado, username );
        signUp({
            nombre,
            cedula,
