...
export const RegisterScreen = ({navigation} : Props) => {
    ...
    const signUp = {nombre, email, password, cedula,/*fecha Nacimiento , sexo */ estado_civil, religion, ocupacion, lugar_nacimiento, residencia, domicilio, telefono, estado, username } : Re
