    ...
    const onRegister = async () =>  {
        ...
        */
                    ...
                    if ( image ) {
                        ...
                        data.append( 'profileImage', fullImageData );
                        
                        dermatologiaApi.post( '/profile/profile-img-upload', data, {
                        headers: {
                        'accept': 'application/json',
                        'Accept-Language': 'en-US,en;q=0.8',
                        "_Content-Type": `multipart/form-data; boundary=${data._boundary}`,
                        get "Content-Type"() {
                        ...
                        .then( ( response ) => {if ( 200 === response.status ) {
                            ...
                            if ( 'LIMIT_FILE_SIZE' === response.data.error.code ) {
                                ...
                                const fileLocation = fileData.location;  
                        ...
                        // If another error OC
                        return toast.error('Ocurrió un error al subir la imagen', {
                            position: "top-center",
                            autoClose: 5000,
                            hideProgressBar: false,
                            closeOnClick: true,
