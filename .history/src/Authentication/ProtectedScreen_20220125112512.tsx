...
import { TabsNavigator } from '../screens/StackNavigator/TabsNavigator'
    ...
    return (
        <>
           ...
           <Drawer.Navigator
                ...
                defaultScreenOptions={a}
            >
                <Drawer.Screen name="SettingsScreen" options={{ title : 'Home'}} component={TabsNavigator} />
