...
export const RegisterScreen = ({navigation} : Props) => {
    ...
    //USEFORM
    const {email, password, nombre, cedula, /*fecha_nacimiento,*/ sexo, estado_civil, religion, ocupacion, lugar_nacimiento, residencia, domicilio, telefono, estado,  username,onChange} = useForm({
        email : '',
        password : '',
        nombre : '',
        cedula : '',
    ...
    const signUp = {nombre, email, password, cedula, }
