...
export const RegisterScreen = ({navigation} : Props) => {
    ...
    const signUp = asymc {nombre, email, password, cedula,/*fecha Nacimiento , sexo */ estado_civil, religion, ocupacion, lugar_nacimiento, residencia, domicilio, telefono, estado, username } : RegisterData = {
        try{
