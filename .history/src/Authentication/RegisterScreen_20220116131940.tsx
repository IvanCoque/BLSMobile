...
export const RegisterScreen = ({navigation} : Props) => {
    ...
    //USEFORM
    const {email, password, nombre, cedula,  sexo, estado_civil, religion, ocupacion, lugar_nacimiento, residencia, domicilio, telefono, estado, imagen, username,onChange} = useForm({
        email : '',
        password : '',
        nombre : '',
        cedula : '',
