...
import {ReservaCitasFCTimeScreen} from '../screens/ReservaCitas/ReservaCitasFCTimeScreen';
...
return (
    ...
    >
        <BottomTabAndroid.Screen name="Reserva de Citas" options = {{tabBarLabel : 'Reserva de citas'}} component={ReservaCitasFCTimeScreen} />
