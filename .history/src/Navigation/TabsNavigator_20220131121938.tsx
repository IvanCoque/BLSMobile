...
return (
    ...
    >
        <BottomTabAndroid.Screen name="Reserva de Citas" options = {{tabBarLabel : 'Reserva'}} component={ReservaCitasScreen} />
        <BottomTabAndroid.Screen name="Historial de visitas" component={Estadisticas} />
        <BottomTabAndroid.Screen name="Perfil Usuario" component={PerfilUsuario} />
        <BottomTabAndroid.Screen name="Avance del tratamiento" component={GaleriaImagenes} />
     </BottomTabAndroid.Navigator>
);
}
