...
return (
    <TabsAndroid.Navigator>
        <TabsAndroid.Screen name="Reserva de Citas" component={ReservaCitasScreen}  />
        <TabsAndroid.Screen name="Estadisticas" component={Estadisticas} />
        <TabsAndroid.Screen name="Perfil Usuario" component={PerfilUsuario} />
     </TabsAndroid.Navigator>
);
}
