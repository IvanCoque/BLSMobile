...
import { Button, Keyboard, KeyboardAvoidingView, Platform, ScrollView, Switch, Text, TextInput, TouchableOpacity, View } from 'react-native';
        ...
        >
            <ScrollView>
                <View style = {{
                    ...
                    <CustomSwitch isOn={false} onChange={(value) => onSwitchChange(value, 'isActive')}/>
                    <Text > {JSON.stringify(state, null, 5)}</Text>
                    <View style = {loginStyles.formContainer}>
                        {/* Keyboard avoid view*/}
                        <FotoPerfil foto = {user?.}/>
