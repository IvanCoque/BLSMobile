...
export const ReservaCitasFCScreen: React.FC = () => {
  ...
  const reservarCita = () =>{
    ...
    const fechaStartNew = new Date(parseInt(anio),parseInt(dia)-1, parseInt(mes),  parseInt(horaStartTime)-5, parseInt(minutosStartTime), parseInt(segundosStartTime));
    const fechaEndNew = new Date(parseInt(anio),parseInt(dia)-1, parseInt(mes),  parseInt(horaStartTime)-5, parseInt(minutosStartTime), parseInt(segundosStartTime))
    ...
    dermatologiaApi.post('/reservasCitas',{
      ...
      fecha_hora_inicio_reserva : new Date(fechaStartTime),
      fecha_hora_fin_reserva: new Date(fechaEndTime),               
      estado_reserva : 1,                                                      
      id_usuario : user._id,                    
