...
import {Button, Dimensions, Image, Modal, Platform, SafeAreaView, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View} from 'react-native';
...
export const ReservaCitasFCScreen: React.FC = () => {
  ...
  const reservarCita = () =>{
    ...
    const dia = dateText.substring(3,5);
    const mes = dateText.substring(0,2);
    
    const fecha = anio + '-' + mes + '-' + dia;
    
    const fechaStartTime = fecha + ' ' + startTimeText.substring(0,startTimeText.length-3);
    const fechaEndTime = fecha + ' ' + endTimeText.substring(0,endTimeText.length-3);
   
    console.log(motivoReserva)
   
    console.log(fechaStartTime) 
    ...
    dermatologiaApi.post('/reservasCitas',{
      motivo_reserva : "Dermatitis",
      "fecha_hora_inicio_reserva" : "2022-02-05 14:12:40",
      "fecha_hora_fin_reserva": "2022-02-05 16:12:40",               
      "estado_reserva" : "1",                                                      
      "id_usuario" : "61e5c3a803ef2f213af92e2a",                    
      "id_profesional" : "61fdefd69ce93f8d4d4716a3",                 
      "id_especialidad" : "61fdeff79ce93f8d4d4716a5",                
      "id_consultorio" : "61fdf0069ce93f8d4d4716a7"    
    })
  }
