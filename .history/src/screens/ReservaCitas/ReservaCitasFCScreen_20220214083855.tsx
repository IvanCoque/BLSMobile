...
export const ReservaCitasFCScreen: React.FC = () => {
  ...
  const reservarCita = () =>{
    ...
    const fechaStartTime = new Date(fecha + ' ' + startTimeText.substring(0,startTimeText.length-4));
    const fechaEndTime = new Date(fecha + ' ' + endTimeText.substring(0,endTimeText.length-4));
