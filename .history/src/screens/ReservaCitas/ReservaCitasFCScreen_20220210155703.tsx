...
export const ReservaCitasFCScreen: React.FC = () => {
  ...
  const [selectedDay, setSelectedDay] = useState<Consultorio>('2022-02-09');
  ...
  //CONSULTORIO
  const [consultorios, setConsultorios] = useState<JSON[]>([]);
  ...
  useEffect(() => {
    ...
    //   );
        ...
        const getConsultorios = async () =>{
          ...
          const consultoriosSet: JSON[] = await response.data;
          console.log('desde consultorios')
          console.log(consultoriosSet);
          setConsultorios(consultoriosSet);
          console.log(JSON.parse(consultorios))
