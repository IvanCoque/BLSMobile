...
import {Button, Dimensions, Modal, Platform, SafeAreaView, ScrollView, StyleSheet, Text, TouchableOpacity, View} from 'react-native';
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <Modal
        ...
        >
            <ScrollView contentContainerStyle= {} style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.5)' }}>  
                <View style={{ 
                    ...
                    >
                        <Picker.Item label="Seleccione un consultorio" value="0" />
                        {
                           Object.values(consultorios).map(data => (
                               <Picker.Item label={`${data.direccion_consultorio}`} value={data._id} />
