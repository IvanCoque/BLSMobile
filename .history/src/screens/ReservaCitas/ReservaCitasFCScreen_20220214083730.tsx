...
export const ReservaCitasFCScreen: React.FC = () => {
  ...
  const reservarCita = () =>{
    ...
    const fechaStartTime = new Date(fecha + ' ' + startTimeText.substring(0,startTimeText.length-3));
    const fechaEndTime = new Date(fecha + ' ' + endTimeText.substring(0,endTimeText.length-3);
   
    console.log(motivoReserva)
   
    console.log(Date.parse(fechaStartTime)) 
    
    console.log(Date.parse(fechaEndTime))
