...
import {Button, Dimensions, Image, Modal, Platform, SafeAreaView, ScrollView, StyleSheet, Text, TouchableOpacity, View} from 'react-native';
...

                    {
                      profesional ? (
                        <Image 
                          ...
                          source = {{uri : profesional.imagen_profesional}}
                        />
                      )
                      :
                      (
