...
export const ReservaCitasFCScreen: React.FC = () => {
  ...
  const reservarCita = () =>{
    ...
    const fechaStartTime = `${fecha}T${startTimeText.substring(0,startTimeText.length-3)}.417-07:00Z`;
    const fechaEndTime = `${fecha}T${endTimeText.substring(0,endTimeText.length-3)}.417-07:00Z`;
