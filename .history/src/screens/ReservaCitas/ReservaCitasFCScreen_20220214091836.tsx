...
export const ReservaCitasFCScreen: React.FC = () => {
  ...
  const reservarCita = () =>{
    ...
    const fechaNueva =new Date(fecha).setHours(parseInt(horaStartTime),parseInt(minutosStartTime),parseInt(segundosStartTime));
    console.log(fechaNueva.toLocaleString())
