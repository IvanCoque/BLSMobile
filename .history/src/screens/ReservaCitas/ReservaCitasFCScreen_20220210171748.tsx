...
import { Consultorio, IdEspecialidad, IdProfesional, ReservaCita } from '../../interfaces/appInterfaces';
...
export const ReservaCitasFCScreen: React.FC = () => {
  ...
  //ESPECIALIDADES
  const [especialidades, setEspecialidades] = useState<IdEspecialidad>([]);
  const [especialidad, setEspecialidad] = useState('')
  //PROFESIONALES
  const [profesionales, setProfesionales] = useState<IdProfesional>([]);
  ...
  const generarProfesionales = (itemValue : any) =>{
    ...
    setConsultorio(itemValue.id_profesional);
    setEspecialidades(JSON.parse(itemValue.profesionales));
    console.log('state consultorio')
