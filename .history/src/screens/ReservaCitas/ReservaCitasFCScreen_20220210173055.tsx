                          ...
                          >
                              <Picker.Item label="Seleccione una especialidad" value="0" />
                              {
                                Object.values(profesionales).map(data => (
                                    <Picker.Item label={`${data.nombre_profesional} - ${data.apellido_profesional}`} value={{id_profesional : data._id, imagen_profesional : JSON.stringify(data.id_profesional)}} />
