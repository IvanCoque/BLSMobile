...
export const AuthProvider = ({children} : any)=>{
   ...
   const  signUp = async ({nombre, cedula, fecha_nacimiento, sexo, estado_civil, religion, ocupacion, lugar_nacimiento, residencia, domicilio, telefono, estado, imagen, username, email, password, roles} : RegisterData)=> {
    try{
        const resp = await dermatologiaApi.post('/auth/signup', {email, password})
        console.log(resp.data);
        const token = resp.data.token;
        const user = resp.data.datosUsuario;
        dispatch({
